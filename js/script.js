...
function Stop() {
    clearInterval(timer);
    timer = null;
    //setTimeout(alert("Вы проиграли! Результат: " + player.result + 'м'), 1000);
    setTimeout(function() { alert("Вы проиграли! Результат: " + player.result + 'м'); }, 10);
}
